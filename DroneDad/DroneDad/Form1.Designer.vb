...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        Button5 = New Button()
        Label1 = New Label()
        DroneVendingMachine16 = New DroneVendingMachine()
        SuspendLayout()
        ' 
        ' ShoppingCart
        ' 
        ...
        DroneVendingMachine1.label = "Drone Body"
        ...
        DroneVendingMachine1.Pictore = My.Resources.Resources._619WbcMO36S__AC_UF350_350_QL80_
        DroneVendingMachine1.price = New Decimal(New Integer() {3199, 0, 0, 131072})
        ...
        DroneVendingMachine2.label = "Carbon Fiber 6 Armed Drone With Landing Gears And Camera Mount"
        ...
        DroneVendingMachine2.Pictore = My.Resources.Resources.S896e1557edb04c878a67e7c0f7c8f350S_jpg_640x640Q90_jpg_
        DroneVendingMachine2.price = New Decimal(New Integer() {8999, 0, 0, 131072})
        ...
        DroneVendingMachine3.label = "Racing Drone Frame"
        ...
        DroneVendingMachine3.Pictore = My.Resources.Resources.DroneBody3
        DroneVendingMachine3.price = New Decimal(New Integer() {3899, 0, 0, 131072})
        ...
        DroneVendingMachine4.label = "Drone with cheese"
        ...
        DroneVendingMachine4.Pictore = My.Resources.Resources.DroneBody4
        DroneVendingMachine4.price = New Decimal(New Integer() {5621, 0, 0, 131072})
        ...
        DroneVendingMachine5.label = "Rubber Ducky Drone"
        ...
        DroneVendingMachine5.Pictore = My.Resources.Resources.Ducky
        DroneVendingMachine5.price = New Decimal(New Integer() {40078, 0, 0, 131072})
        ...
        DroneVendingMachine6.Location = New Point(9, 106)
        DroneVendingMachine6.Margin = New Padding(3, 2, 3, 2)
        DroneVendingMachine6.Name = "DroneVendingMachine6"
        DroneVendingMachine6.Pictore = My.Resources.Resources.Motor5
        DroneVendingMachine6.price = New Decimal(New Integer() {2599, 0, 0, 131072})
        ...
        DroneVendingMachine7.Location = New Point(457, 11)
        DroneVendingMachine7.Margin = New Padding(3, 2, 3, 2)
        DroneVendingMachine7.Name = "DroneVendingMachine7"
        DroneVendingMachine7.Pictore = My.Resources.Resources.Motor4
        DroneVendingMachine7.price = New Decimal(New Integer() {3789, 0, 0, 131072})
        ...
        DroneVendingMachine8.Location = New Point(308, 11)
        DroneVendingMachine8.Margin = New Padding(3, 2, 3, 2)
        DroneVendingMachine8.Name = "DroneVendingMachine8"
        DroneVendingMachine8.Pictore = My.Resources.Resources.Motor3
        DroneVendingMachine8.price = New Decimal(New Integer() {5899, 0, 0, 131072})
        ...
        DroneVendingMachine9.Location = New Point(159, 11)
        DroneVendingMachine9.Margin = New Padding(3, 2, 3, 2)
        DroneVendingMachine9.Name = "DroneVendingMachine9"
        DroneVendingMachine9.Pictore = My.Resources.Resources.Motor2
        DroneVendingMachine9.price = New Decimal(New Integer() {7485, 0, 0, 131072})
        ...
        DroneVendingMachine10.label = "Drone Motor"
        DroneVendingMachine10.Location = New Point(10, 11)
        DroneVendingMachine10.Margin = New Padding(3, 2, 3, 2)
        DroneVendingMachine10.Name = "DroneVendingMachine10"
        DroneVendingMachine10.Pictore = My.Resources.Resources.Motor1
        DroneVendingMachine10.price = New Decimal(New Integer() {6299, 0, 0, 131072})
        ...
        DroneVendingMachine11.label = "Carbon Fiber "
        DroneVendingMachine11.Location = New Point(9, 10)
        DroneVendingMachine11.Margin = New Padding(3, 2, 3, 2)
        DroneVendingMachine11.Name = "DroneVendingMachine11"
        DroneVendingMachine11.Pictore = My.Resources.Resources.Blade1
        DroneVendingMachine11.price = New Decimal(New Integer() {2775, 0, 0, 131072})
        ...
        DroneVendingMachine12.label = "2 Blade Propeller"
        DroneVendingMachine12.Location = New Point(159, 9)
        DroneVendingMachine12.Margin = New Padding(3, 2, 3, 2)
        DroneVendingMachine12.Name = "DroneVendingMachine12"
        DroneVendingMachine12.Pictore = My.Resources.Resources.Blade2
        DroneVendingMachine12.price = New Decimal(New Integer() {1015, 0, 0, 131072})
        ...
        DroneVendingMachine13.label = "Toroidal Propellers"
        DroneVendingMachine13.Location = New Point(308, 9)
        DroneVendingMachine13.Margin = New Padding(3, 2, 3, 2)
        DroneVendingMachine13.Name = "DroneVendingMachine13"
        DroneVendingMachine13.Pictore = My.Resources.Resources.Blade3
        DroneVendingMachine13.price = New Decimal(New Integer() {1843, 0, 0, 131072})
        ...
        DroneVendingMachine14.label = "3 Blade Led Propellers"
        DroneVendingMachine14.Location = New Point(457, 9)
        DroneVendingMachine14.Margin = New Padding(3, 2, 3, 2)
        DroneVendingMachine14.Name = "DroneVendingMachine14"
        DroneVendingMachine14.Pictore = My.Resources.Resources.Blade4
        DroneVendingMachine14.price = New Decimal(New Integer() {3499, 0, 0, 131072})
        ...
        DroneVendingMachine15.label = "Tri blade Toroidal Propellers"
        ...
        DroneVendingMachine15.Pictore = My.Resources.Resources.Blade5
        DroneVendingMachine15.price = New Decimal(New Integer() {2480, 0, 0, 131072})
        ...
        ' 
        DroneVendingMachine16.BorderStyle = BorderStyle.Fixed3D
        DroneVendingMachine16.count = 0
        DroneVendingMachine16.label = "Cheese"
        DroneVendingMachine16.Location = New Point(513, 116)
        DroneVendingMachine16.Margin = New Padding(3, 2, 3, 2)
        DroneVendingMachine16.Name = "DroneVendingMachine16"
        DroneVendingMachine16.Pictore = My.Resources.Resources.Cheese
        DroneVendingMachine16.price = New Decimal(New Integer() {2, 0, 0, 0})
        DroneVendingMachine16.Size = New Size(144, 91)
        DroneVendingMachine16.TabIndex = 29
        ' 
        ' Form1
        ' 
        ...
        Controls.Add(DroneVendingMachine16)
        Controls.Add(Label1)
